...
def test_historical_all_35_compatibility():
    with tempfile.TemporaryDirectory() as root:
        names=trading_framework_registry.list_names();assert len(names)==35
        for name in names:
...
if __name__=="__main__":test_historical_all_35_compatibility();print("test_historical_all_35_compatibility passed")
