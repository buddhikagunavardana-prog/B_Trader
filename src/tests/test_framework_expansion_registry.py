...
def test_registry_and_configs_are_synchronized():
 ...
 configs=list(Path("src/config/framework_research").glob("*.json")); assert len(configs)==len(trading_framework_registry.list_names())
...
if __name__=="__main__":test_registry_and_configs_are_synchronized();print("test_framework_expansion_registry passed")
